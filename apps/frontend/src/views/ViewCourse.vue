    ...
    <v-card>
      ...
      <v-card-text>
        ...
        <div class="align-items-center">
          ...
          <v-spacer />
          <v-btn v-if="courseRole == 'TEACHER' || courseRole == 'TUTOR'" variant="text" @click="openMembersView"> Mitglieder verwalten </v-btn>
        </div>
      </v-card-text>
    </v-card>
