...
@Injectable()
export class BackendStartupLogger implements OnApplicationBootstrap {
  private readonly logger = new Logger(BackendStartupLogger.name);
